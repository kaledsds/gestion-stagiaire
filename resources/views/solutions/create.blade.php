...
<section class="section dashboard">
    <div class="row">
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Résoudre le problème</h5>

                    <!-- Multi Columns Form -->
                    <form method="POST" action="{{ route('solutions.store', $probleme_id) }}" class="row g-3"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="file" class="form-control" name="fichier_solution" id="fichier-description">
                        </div>
                        <div class="col-md-6">
                            <label for="date-soumission" class="form-label">Date soumission</label>
                            <input type="date" class="form-control" name="date_response" id="date-soumission">
                        </div>
                        <div class="col-12">
